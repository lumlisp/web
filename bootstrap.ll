...
(import "lumlisp/web/Schema")
(import "lumlisp/web/Migration")
...
(define (guess-mime path)
  (cond
    ((string-suffix? path ".css") "text/css")
    ((string-suffix? path ".js") "application/javascript")
    ((string-suffix? path ".mjs") "application/javascript")
    ((string-suffix? path ".wasm") "application/wasm")
    ((string-suffix? path ".png") "image/png")
    ((string-suffix? path ".jpg") "image/jpeg")
    ((string-suffix? path ".jpeg") "image/jpeg")
    ((string-suffix? path ".webp") "image/webp")
    ((string-suffix? path ".gif") "image/gif")
    ((string-suffix? path ".svg") "image/svg+xml")
    ((string-suffix? path ".ico") "image/x-icon")
    ((string-suffix? path ".json") "application/json")
    ((string-suffix? path ".html") "text/html")
    ((string-suffix? path ".txt") "text/plain")
    ((string-suffix? path ".pdf") "application/pdf")
    ((string-suffix? path ".woff2") "font/woff2")
    ((string-suffix? path ".woff") "font/woff")
    ((string-suffix? path ".ttf") "font/ttf")
    ((string-suffix? path ".otf") "font/otf")
