...
(defmethod IndexController index (self ctx)
  (flash/set \"greeting\" \"Welcome to LLWeb!\")
...
(println "")
    ...
    (println "  ll web.ll generate controller posts index show create")
    (println "  ll web.ll generate model post title:string body:text")
